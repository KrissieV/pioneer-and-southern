<?php
/*
Plugin Name: Honeystreet Gravity Forms Cutomizations
Plugin URI: http://www.honeystreet.com
Description: Custom Functions to extend Gravity Forms Usability
Version: 1.0
 ...
 *
 * Adds support for using Gravity Form merge tags in your post content. This functionality requires that 
 * the entry ID is passed to the post via the "eid" parameter.
