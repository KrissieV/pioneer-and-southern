	...
	<div class="entry-content">
			...
			if( have_rows('content') ):
			    ...
			    while ( have_rows('content') ) : the_row();
					...
					<div class="section no-marg">
						<?php // check if the nested flexible content field has rows of data
		...
		<div class="sidebar-content">
			...
			if( have_rows('sidebar') ):
			    ...
			    while ( have_rows('sidebar') ) : the_row();
			        ...
			        if( get_row_layout() == 'pay_your_bill_link' ): ?>
			        <div class="box link bill">
				        <?php the_field('bill_text','option'); ?>
					    <a href="<?php the_field('bill_link','option'); ?>" target="_blank" ></a>
						<div class="clear"></div>
			        </div>
			        <?php elseif( get_row_layout() == 'energy_savings_link' ): ?>
			        <div class="box link bank">
				        <?php the_field('bank_text','option'); ?>				        
					    
						<a href="<?php the_field('bank_link','option'); ?>" ></a>
						<div class="clear"></div>
			        </div>
			        <?php elseif( get_row_layout() == 'call_before_you_dig_information' ): ?>
			        <div class="box dig">				        
				        <?php the_field('dig_text','option'); ?>
				        <div class="clear"></div>
			        </div>
			        <?php endif;
