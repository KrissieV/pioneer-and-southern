...
<link href="http://pioneerelectric.coop/favicon.ico" rel="icon" type="image/x-icon" />
				...
				<div class="site-branding col fifth">
					<?php if ( get_theme_mod( 'honeystreet_logo' ) ) : ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" id="site-logo" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
							<img src="<?php echo get_theme_mod( 'honeystreet_logo' ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" width=210>
			 			</a>
